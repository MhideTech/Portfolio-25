    ...
    <div className="my-20">
      ...
      <section className="text-gray-800 py-1 grid grid-cols-2 md:grid-cols-3 items-center lg:gap-10 xl:gap-36 w-11/12 xl:w-10/12 mx-auto gap-10">
        ...
        <div className="col-span-3 md:col-span-1 relative flex justify-center xl:justify-end">
          ...
          ></div>
          <div className="absolute -left-2 md:-left-24 top-20 bg-white px-4 py-2 rounded-full flex items-center shadow-lg">
            <span className="w-3 h-3 bg-pink-500 rounded-full mr-2"></span>
            <span className="text-black font-medium">Experience Developer</span>
          </div>
          <div className="absolute -right-2 md:-right-8 bottom-20 bg-white px-4 py-2 rounded-full flex items-center shadow-lg w-fit">
