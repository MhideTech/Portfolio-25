...
function Footer() {
  ...
  console.log(date);
  return (
    <section className="flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-800 py pt-16 pb-8 px-8">
      ...
      <h2 className="text-4xl font-bold text-gray-800 dark:text-gray-200 text-center mb-6 animate__animated animate__fadeInUp">
      ...
      <div className="flex space-x-4 animate__animated animate__fadeInUp">
        <a
          ...
          className="flex items-center px-8 py-3 bg-gray-800 dark:bg-gray-200 dark:text-gray-800 text-gray-200 rounded-full shadow hover:bg-gray-800"
        >
          Send me an email
        </a>
      </div>
      ...
      <div className="mt-12 flex justify-between w-full text-gray-800 items-end">
        <p className="text-md animate__animated animate__fadeInLeft text-gray-600 dark:text-gray-200">
        ...
        <div className="flex gap-2 text-center flex-col animate__animated animate__fadeInRight">
          <p className="text-gray-600 dark:text-gray-200">My Social Handles:</p>
          <SocialMediaIcons />
        </div>
      </div>
    </section>
