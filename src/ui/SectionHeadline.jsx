function SectionHeadline({ children }) {
  return (
    <div className="flex items-center justify-center my-8 lg:w-11/12 xl:w-10/12 mx-auto">
      <div className="border-2 border-t border-gray-800 dark:border-gray-50 flex-grow"></div>
